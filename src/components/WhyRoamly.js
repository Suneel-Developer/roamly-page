        ...
        <section className='w-full px-4 mt-32 md:mt-64 mb-40 lmd:mb-[500px]'>
            ...
            <div className='max-w-[1300px] mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-20'>
                <div className='flex flex-col items-center justify-start text-center gap-8'>
                    ...
                    <h4 className='text-deep_gray f-anvenirnext-db text-[28px]'>Overcome Creative Blocks</h4>
                ...
                <div className='flex flex-col items-center justify-start text-center gap-8'>
                    ...
                    <h4 className='text-deep_gray f-anvenirnext-db text-[28px]'>Boost & Sustain Productivity</h4>
                ...
                <div className='flex flex-col items-center justify-start text-center gap-8'>
                    ...
                    <h4 className='text-deep_gray f-anvenirnext-db text-[28px]'>Feel-good emotions</h4>
